address 0x6d0177e989c24a754898079abcda70faca206529a4101072dfa54b91d17727b5 {
...
module RockPaperScissors {
   ...
   public entry fun set_player_move(account: &signer, player_move: u8) acquires Game {
    // Check if the player_move is valid (example: 0-2 for rock, paper, scissors)
    assert!(player_move >= 0 && player_move <= 2, 100);

    // Ensure the Game resource exists before borrowing it
